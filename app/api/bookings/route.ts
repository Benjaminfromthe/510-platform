...
const bookingSchema = z.object({
  ...
  propertySize: z.string().min(1, "Property size is required.").optional().default("Not specified"),
  urgency: z.string().min(1, "Urgency is required.").optional().default("Flexible"),
  ...
  try {
    ...
    const booking = await prisma.booking.create({
      data: {
        ...
        propertySize: parsed.data.propertySize || "Not specified",
        urgency: parsed.data.urgency || "Flexible",
