...
export default function PageNav() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-40 border-b border-black/10 bg-white/95 backdrop-blur-md">
        ...
        {/* Mobile dropdown */}
        {menuOpen && (
          <div className="border-t border-black/10 bg-white/98 px-3 py-3 lg:hidden">
